class Addfieldstousers < ActiveRecord::Migration
  def self.up
    add_column  :users, :login, :string, :null => false, :default => 0                # optional, you can use email instead, or both
    add_column  :users, :crypted_password, :string, :null => false, :default => 0                # optional, see below
    add_column  :users, :password_salt, :string, :null => false, :default => 0                # optional, but highly recommended
    add_column  :users, :persistence_token, :string, :null => false, :default => 0                # required
    add_column  :users, :single_access_token, :string, :null => false, :default => 0                # optional, see Authlogic::Session::Params
    add_column  :users, :perishable_token, :string, :null => false, :default => 0                # optional, see Authlogic::Session::Perishability
